#' @title Construct model and contrast matrix
#'
...
#' @examples
#' data("warpbreaks")
#' twoFactorInteraction(dataset = warpbreaks, fac1 = "wool", fac2 = "tension")
#' twoFactorInteraction(dataset = warpbreaks, fac1 = "tension", fac2 = "wool")
#'
...
#'
#' @export
twoFactorInteraction <- function(dataset, fac1, fac2) {
