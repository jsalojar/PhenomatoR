...
#' @description
#'
#' Function draws non-clustered heatmaps with
...
#'
#' @return
#' If no clustering and \code{print.heatmap} is TRUE: invisibly, "gg" class object representing the heatmap
#'
...
#'                               random.effects = "Tray.ID")$plot.values
#'
#' ##heatmap with no clustering
#' heatmapper(wide.df = res, column.name = "genotypes", row.id = "phenotype")
#'
